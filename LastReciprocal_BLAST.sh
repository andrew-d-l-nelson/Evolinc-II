...
if [[ ! $DB ]]; then
    lastdb -P 0 Reciprocal_BLAST_DB/$query_genome.blast.out $query_genome
    ...
    lastal -E10 -P 0 -f BlastTab+ Reciprocal_BLAST_DB/$query_genome.blast.out $Put_ortholog > Reciprocal_BLAST_Return/$Put_ortholog.Reciprocal.out
...
sed '/^#/ d' Reciprocal_BLAST_Return/$Put_ortholog.Reciprocal.stripped.out > Reciprocal_BLAST_Return/$Put_ortholog.Reciprocal.stripped.cmtsrmd.out
cat Reciprocal_BLAST_Return/$Put_ortholog.Reciprocal.stripped.cmtsrmd.out > Reciprocal_BLAST_Return/$Put_ortholog.Reciprocal.stripped.out 

# Convert blast result to gff
perl /Lastblast2gff_recip.pl -i Reciprocal_BLAST_Return/$Put_ortholog.Reciprocal.stripped.out -s $subject_species -o Reciprocal_BLAST_Return/$Put_ortholog.Reciprocal.stripped.out.gff
