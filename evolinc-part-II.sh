...
mkdir -p $output
mkdir -p BLAST_DB
rm -fr Homology_Search; mkdir Homology_Search
rm -fr Reciprocal_BLAST; mkdir Reciprocal_BLAST
rm -fr Orthologs; mkdir Orthologs
...
python /LastStartup_script.py -b $Blasting_list -i $input_folder -v $value -n $threads
...
python /LastReciprocal_BLAST_startup_script.py -b Reciprocal_list.txt -v $value -n $threads
